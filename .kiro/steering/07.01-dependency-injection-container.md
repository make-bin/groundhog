---
inclusion: fileMatch
fileMatchPattern: ['pkg/utils/container/*.go']
---

The container implementation must be directly used in the following codes,don't change.
**pkg/utils/container/container.go**
```go
package container
